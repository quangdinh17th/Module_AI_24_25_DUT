...
# Example usage
input_folder = "Program/python/final_exam/leaf_data_exam/binary"  # Input folder with images
output_csv = "Program/python/final_exam/KNN_HU/hu_features.csv"  # Output CSV file
